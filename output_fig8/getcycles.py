...
benchmarks = ["ssp_10us_10ms","ssp_100us_10ms","ssp_1000us_10ms","romulus","prosper","dirtybit","vanilla"]
...
if __name__=="__main__":
    ...
    #print(data)
    #print(final_data)
    f_dic = {"type":0,"gapbs":0,"sssp":0,"workloadb":0,"random":0,"sparse":0,"stream":0}
    with open('execution_time.csv', 'w', newline='') as csvfile:
        fieldnames = ['type', 'gapbs','sssp','workloadb','random','sparse','stream']
        ...
        for k1,v1 in final_data.items():
            if(k1 in benchmarks and k1 != "vanilla"):
                if(k1=="ssp_10us_10ms"):
                    d['type'] = "ssp_10us"
                elif(k1=="ssp_100us_10ms"):
                    d['type'] = "ssp_100us"
                elif(k1=="ssp_1000us_10ms"):
                    d['type'] = "ssp_1ms"
                else:
                    d['type'] = k1
