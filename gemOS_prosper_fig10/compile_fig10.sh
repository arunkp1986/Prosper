...
if [[ $bench == "micro" ]];then
    ...
    process "ssp_sparse_init.c" "gemOS_sparse_${gran}.kernel" "$gran" 
elif [[ $bench == "stream" ]];then
    process "ssp_stream_init.c" "gemOS_stream_${gran}.kernel" "$gran"
elif [[ $bench == "random" ]];then
    process "ssp_random_init.c" "gemOS_random_${gran}.kernel" "$gran"
