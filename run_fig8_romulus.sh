...
gem5_path="$CWD/gem5_romulus"
gemOS_path="$CWD/gemOS_romulus"
script_path="$CWD/run_scripts_fig8/romulus"
output_path="$CWD/output_fig8/romulus"
...
#switching to romulus branch

git checkout -f romulus
...
KERNEL_NAME="$gemOS_path/gemOS_romulus.kernel"
export KERNEL_NAME
