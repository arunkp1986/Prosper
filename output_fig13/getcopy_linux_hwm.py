...
def get_files(dirname, files):
    for (dirpath, dirnames, filenames) in os.walk(cwd):
        if (cwd+'/linux/'+dirname in dirpath and "HWM" in dirpath):
...
if __name__=="__main__":
    ...
    for bench in benchmarks:
        files = []
        final_data[bench] = {"4HWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}},
                "8HWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}},
                "16HWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}},
                "24HWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}}}
    ...
    for k1,v1 in final_data.items():
        with open('{0}_hwm_result.csv'.format(k1), 'w', newline='') as csvfile:
            fieldnames = ['hwm','loads','stores']
            ...
            for k2,v2 in v1.items():
                for k3,v3 in v2.items():
                    if(k3 =="hwsw"):
                        ...
                        writer.writerow({'hwm':k2,'loads':loads,'stores':stores})
