...
benchmarks = ["mcf_s","g500_sssp"]
#benchmarks = ["g500_sssp","gaps","stream"]
def get_files(dirname, files):
    for (dirpath, dirnames, filenames) in os.walk(cwd):
        if (cwd+'/linux/'+dirname in dirpath and "LWM" in dirpath):
...
if __name__=="__main__":
    ...
    for bench in benchmarks:
        files = []
        final_data[bench] = {"4LWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}},
                "8LWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}},
                "16LWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}},
                "20LWM":{"hw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0},"hwsw":{"numUsrInsts":0,"numUsrCycles":0,"bitmapStores":0,"lookupFull":0,"evictStores":0,"redundantStores":0,"watermarkStores":0,"stackStores":0,"flushStores":0,"numStoreInsts":0,"simSeconds":0}}}
    ...
    for k1,v1 in final_data.items():
        with open('{0}_lwm_result.csv'.format(k1), 'w', newline='') as csvfile:
            fieldnames = ['lwm','loads','stores']
            ...
            for k2,v2 in v1.items():
                for k3,v3 in v2.items():
                    if(k3 =="hwsw"):
                        loads = int(v3["evictStores"])+int(v3["watermarkStores"])+int(v3["flushStores"])
                        stores = int(v3["bitmapStores"])
                        writer.writerow({'lwm':k2,'loads':loads,'stores':stores})
