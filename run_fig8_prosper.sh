...
script_path="$CWD/run_scripts_fig8/prosper"
output_path="$CWD/output_fig8/prosper"
...
cd $gemOS_path
./compile_fig8.sh micro 8
./compile_fig8.sh sparse 8
./compile_fig8.sh stream 8
./compile_fig8.sh random 8


cd $gem5_path

KERNEL_NAME="$gemOS_path/gemOS_prosper.kernel"
export KERNEL_NAME
